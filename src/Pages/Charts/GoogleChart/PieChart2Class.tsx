        ...
        <CardBody className="chart-block">
          <div className="chart-overflow" id="pie-chart1">
            <Chart
              ...
              data={googleChartDatas.GooglePieChart2.data}
              options={googleChartDatas.GooglePieChart2.option && { is3D: true }}
              rootProps={googleChartDatas.GooglePieChart2.rootProps}
            />
          </div>
        </CardBody>
      </Card>
