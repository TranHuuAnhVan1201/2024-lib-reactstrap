...
import { UpdateUserPropsType, UserUpdateType } from '../../../../../Types/Apps/Contact/ContactTypes'
import { useAppDispatch } from '../../../../../ReaduxToolkit/Hooks';
import { dynamicImage } from '../../../../../Service';
import { setEditData } from '../../../../../ReaduxToolkit/Reducer/ContactSlice';
...
const UpdateUser = ({ editdata, userEditCallback }:UpdateUserPropsType) => {
  ...
  const UpdateContact:SubmitHandler<UserUpdateType> = (updatedData) => {
    const withImageData ={...updatedData,avatar:dynamicImage("user/user.png")}
