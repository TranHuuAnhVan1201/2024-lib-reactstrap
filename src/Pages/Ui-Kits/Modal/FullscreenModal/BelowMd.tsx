...
import { Fullscreenbelow_md, UXDesigner, WebDesign, WedDesigner } from "../../../../utils/Constant";
...
const BelowMd = () => {
  ...
  return (
    <>
      <Button
        color="outline-success-2x"
        className="btn-outline-success-2x"
        onClick={() => {
          toggle();
        }}
      >
