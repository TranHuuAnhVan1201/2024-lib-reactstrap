...
const CollapesBody = ({ collapesId }: propsType) => {
  return (
    <Row>
      <Col xl={6}>
        <Collapse
          className={`multi-collapse dark-accordion ${
            collapesId.collapes1 && "show"
          }`}
        >
          <Card>
            <CardBody className="mt-3 mb-0 collapse-wrapper accordion-light-primary rounded-4">
      ...
      <Col xl={6}>
        <Collapse
          className={`multi-collapse dark-accordion ${
            collapesId.collapes2 && "show"
          }`}
        >
          <Card>
            <CardBody className="mt-3 mb-0 collapse-wrapper accordion-light-warning rounded-4">
